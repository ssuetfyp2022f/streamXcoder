...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/videos', label: 'Videos', icon: Video, color: '#FF6B35' },
    { path: '/editor', label: 'Editor', icon: Code, color: '#61DAFB' },
    { path: '/courses', label: 'Courses', icon: BookOpen, color: '#8CC84B' },
    { path: '/trending', label: 'Trending', icon: TrendingUp, color: '#FF4081' },
  ];
              ...
              >
                ...
                >
                  ...
                  <input 
                    ...
                    className="pl-10 pr-24 py-2.5 bg-transparent outline-none w-64 text-white placeholder-gray-400"
                  />
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 px-3 py-1 text-sm rounded-lg font-medium flex items-center gap-1"
                    style={{ 
                      backgroundColor: '#00ADB5',
                      color: '#FFFFFF'
                    }}
