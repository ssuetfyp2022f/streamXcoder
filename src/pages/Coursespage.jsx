...
const Coursespage = () => {
  ...
  const videos = [
    ...
    { id: "ESnrn1kAD4E", title: "CSS Tutorial for Beginners" },
    { id: "ajdRvxDWH4w", title: "JavaScript Full Course" },
    { id: "HcOc7P5BMi4", title: "HTML Tutorial for Beginners" },
    { id: "e7sAf4SbS_g", title: "Complete C++ Tutorial in One Shot" },
  ];
